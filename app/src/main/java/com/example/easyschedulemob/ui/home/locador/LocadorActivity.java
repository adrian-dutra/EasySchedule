package com.example.easyschedulemob.ui.home.locador;
...
import com.example.easyschedulemob.databinding.ActivityLocadorBinding;
...
public class LocadorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder(
                R.id.navigation_quadras, R.id.navigation_locacoes, R.id.navigation_notifications_locador)
                .build();
